...
class TestBaseModelUnits(unittest.TestCase):
    ...
    def test_create_dataset(self):
        ...
        expected_result = [[0, 14065, 55, 22098, 5, 2, 1, 1], [
            0, 40946, 6265, 6, 25090, 68, 5, 2]]
        self.assertEqual(input_ids, expected_result)
...
class TestPoolingUnits(unittest.TestCase):
    ...
    def test_pooling_functions(self):
        ...
        # Test adding padding tokens to make sure all chunks have exactly 512
        # tokens
        ...
        input_ids, attention_mask = transform_text_to_model_input(
            longer_text, tokenizer, size, step, minimal_length)
